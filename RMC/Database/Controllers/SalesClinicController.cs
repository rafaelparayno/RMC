...
namespace RMC.Database.Controllers
{
    class SalesClinicController
    {
        ...
        public async Task Save(string type, int id,int cid)
        {
            string sql;
            List<MySqlParameter> list = new List<MySqlParameter>();

            sql = @"INSERT INTO salesclinic(invoice_id, type_sales,type_sales_id,customer_id) VALUES
        ...
        public async Task delete(int customerid)
        {
            ...
            string sql = @"DELETE FROM salesclinic WHERE customer_id = @id";
            list.Add(new MySqlParameter("@id", customerid));
